        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mt-4">
              Acreditamos que dirigir é mais que uma habilidade — é uma responsabilidade. Por isso,
              formamos motoristas conscientes, preparados e confiantes para enfrentar qualquer
              estrada.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div
                key={i}
                className="bg-secondary text-secondary-foreground rounded-2xl p-6 text-center border-2 border-primary/20"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="mb-12">
            <span className="text-primary font-bold text-sm uppercase tracking-wider">
              Credenciamento e Formação
            </span>
            <h2 className="text-4xl md:text-5xl font-black mt-2">
              Formação profissional na área de <span className="text-primary">trânsito</span>
            </h2>
          </div>
          ...
          <div className="mt-12 bg-primary/10 border-2 border-primary/30 rounded-2xl p-8 text-center">
            <p className="text-foreground">
              Nossos instrutores mantêm{" "}
              <span className="font-black text-primary">formação contínua</span> e estão sempre
              atualizados com as mais recentes normas e técnicas de segurança no trânsito,
              garantindo a melhor qualidade de ensino para nossos alunos.
            </p>
          </div>
        </div>
      </section>
