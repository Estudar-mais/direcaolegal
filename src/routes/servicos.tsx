  ...
  head: () => ({
    meta: [
      { title: "Serviços — Direção Legal Autoescola" },
      {
        name: "description",
        content:
          "Conheça os serviços da Direção Legal: primeira habilitação, adição de categoria, renovação, reciclagem e mais.",
      },
    ],
  }),
  component: Servicos,
...
const services = [
  {
    ...
    desc: "Aulas práticas em moto, balão e simulado oficial.",
  ...
  },
  {
    ...
    desc: "Habilitação para transporte coletivo de passageiros.",
    img: "https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=800&q=80",
  },
  {
    icon: Truck,
    title: "Categoria E — Carretas",
    desc: "Habilitação para condução de veículos articulados e carretas.",
  ...
  },
  {
    ...
    desc: "Adicione novas categorias à sua CNH atual.",
    img: "https://images.unsplash.com/photo-1514316454349-750a7fd3da3a?w=800&q=80",
  },
  {
    icon: Heart,
    title: "Aulas Extras",
    desc: "Pratique mais e ganhe confiança ao volante.",
      ...
      <section className="bg-background py-16 text-center">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-black mt-2">
            Tudo para sua <span className="text-primary">habilitação</span>
          </h1>
          <p className="mt-4 max-w-xl mx-auto text-secondary-foreground/70 font-medium">
            Escolha o serviço ideal para você. Condições especiais e parcelamento em até 12x.
          </p>
        </div>
      </section>
      ...
      <section className="pb-24 pt-4 bg-[#fdfdfc]">
        <div className="container mx-auto px-4 lg:px-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((s, i) => (
            <Card
              key={i}
              className="group relative overflow-hidden bg-[#0a0a0a] rounded-[24px] border-0 text-left transition-all hover:-translate-y-2 hover:shadow-2xl flex flex-col min-h-[460px] md:min-h-[420px]"
            >
              {/* IMAGE TOP HALF */}
              {s.img && (
              ...
              <div className="relative z-10 flex flex-col flex-1 p-6 pt-2">
                ...
                <p className="text-[14px] text-white/70 mt-2 mb-8 leading-relaxed font-medium">
                  {s.desc}
                </p>
                ...
                <div className="mt-auto">
                  <Button
                    asChild
                    className="w-full font-bold bg-transparent text-white border border-primary/50 rounded-lg hover:bg-primary hover:text-black hover:border-primary transition-colors h-[42px]"
                  >
